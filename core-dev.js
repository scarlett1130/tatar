...
function showManual(c, id) {
	...
	if (p!=null) {
		p.innerHTML = '<div id="_pwin" class="popup3"><div id="drag" onmousedown="dragStart(event, \'_pwin\')"></div><a href="#" onClick="hideManual(); return false;"><img src="ftd-style/x.gif" border="1" class="popup4" alt="Move"></a><iframe frameborder="0" id="Frame" src="help.php?c='+c+'&id='+id+'" width="412" height="440" border="0"></iframe></div>';
	}
...
function goto_guide (value) {
	...
	if (p!=null) {
		if(!_vflag) {
			p.innerHTML = '<div id="_pwin" class="popup3 quest"><div id="drag" onmousedown="dragStart(event, \'_pwin\')"></div><a href="#" onClick="showTask();return false;"><img src="ftd-style/x.gif" border="1" class="popup4" alt="Move"></a><img src="ftd-style/default/plus/loading.gif" width="48" height="48" alt="loading"></div>';
		}
			...
			if (xmlHttp.readyState == 4) {
				if (xmlHttp.status == 200 && _flag == -1 && !_vflag) {
					if (xmlHttp.responseText != '') {
						p.innerHTML = '<div id="_pwin" class="popup3 quest"><div id="drag" onmousedown="dragStart(event, \'_pwin\')"></div><a href="#" onClick="showTask();return false;"><img src="ftd-style/x.gif" border="1" class="popup4" alt="Move"></a>' + xmlHttp.responseText + '</div>';
						init();
					}
