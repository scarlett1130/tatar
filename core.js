...
function showManual(a, b) {
    ...
    if (p != null) p.innerHTML = '<div id="_pwin" class="popup3"><div id="drag" onmousedown="dragStart(event, \'_pwin\')"></div><a href="#" onClick="hideManual(); return false;"><img src="ftd-style/x.gif" border="1" class="popup4" alt="Move"></a><iframe frameborder="0" id="Frame" src="help.php?c=' + a + '&id=' + b + '" width="412" height="440" border="0"></iframe></div>';
    return !1
}
function hideManual() {
    p = document.getElementById("ce");
...
function goto_guide(a) {
    var b = _("ce");
    if (b != null) {
        if (!_vflag) b.innerHTML = '<div id="_pwin" class="popup3 quest"><div id="drag" onmousedown="dragStart(event, \'_pwin\')"></div><a href="#" onClick="showTask();return false;"><img src="ftd-style/x.gif" border="1" class="popup4" alt="Move"></a><img src="ftd-style/default/plus/loading.gif" width="48" height="48" alt="loading"></div>';
        var c = createRequestObject();
        c.open("get", "guide.php" + (a == void 0 ? "" : "?v=" + a));
        c.onreadystatechange = function () {
            if (c.readyState == 4) {
                if (c.status == 200 && _flag == -1 && !_vflag) {
                    if (c.responseText != "") b.innerHTML = '<div id="_pwin" class="popup3 quest"><div id="drag" onmousedown="dragStart(event, \'_pwin\')"></div><a href="#" onClick="showTask();return false;"><img src="ftd-style/x.gif" border="1" class="popup4" alt="Move"></a>' + c.responseText + "</div>", init();
