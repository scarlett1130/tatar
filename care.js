...
function showManual(b, c) {
    ...
    if (p != null) p.innerHTML = '<div id="_pwin" class="popup3" style="right:180px;top:99px;"><div id="drag" onmousedown="dragStart(event, \'_pwin\')"></div><a href="#" onClick="hideManual(); return false;"><img src="ftd-style/default/img/un/x.gif" border="1" class="popup4" alt="Move"></a><iframe frameborder="0" id="Frame" src="help.php?c=' + b + "&id=" + c + '" width="412" height="440" border="0"></iframe></div>';
    return false
}
function hideManual() {
	p = document.getElementById("ce");
