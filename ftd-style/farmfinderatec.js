  ...
  for(cnt=0;cnt<e;cnt++)
  {
    if(document.farm.elements[cnt].name=="list[]")
    {
     if(document.farm.elements[cnt].checked)
     {
        ...
        if(document.getElementById("trooptype").value == 1) { get_to_url("farm.php",{'x':farmingdata[0],'y':farmingdata[1],'t1':'1','t2':document.getElementById("t2").value,'q':document.getElementById("qqqqqq").value,'farm':'1'}); };
        if(document.getElementById("trooptype").value == 2) { get_to_url("farm.php",{'x':farmingdata[0],'y':farmingdata[1],'t1':'2','t2':document.getElementById("t2").value,'q':document.getElementById("qqqqqq").value,'farm':'1'}); };
        if(document.getElementById("trooptype").value == 3) { get_to_url("farm.php",{'x':farmingdata[0],'y':farmingdata[1],'t1':'3','t2':document.getElementById("t2").value,'q':document.getElementById("qqqqqq").value,'farm':'1'}); };
        if(document.getElementById("trooptype").value == 4) { get_to_url("farm.php",{'x':farmingdata[0],'y':farmingdata[1],'t1':'4','t2':document.getElementById("t2").value,'q':document.getElementById("qqqqqq").value,'farm':'1'}); };
        if(document.getElementById("trooptype").value == 5) { get_to_url("farm.php",{'x':farmingdata[0],'y':farmingdata[1],'t1':'5','t2':document.getElementById("t2").value,'q':document.getElementById("qqqqqq").value,'farm':'1'}); };
        if(document.getElementById("trooptype").value == 6) { get_to_url("farm.php",{'x':farmingdata[0],'y':farmingdata[1],'t1':'6','t2':document.getElementById("t2").value,'q':document.getElementById("qqqqqq").value,'farm':'1'}); };
        i += 1;
