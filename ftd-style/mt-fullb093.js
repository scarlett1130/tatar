...
this.each(function(c,b){if($type(c)=="function"){c.run(a);}});}});(function(){var c={a:"[أ ظ„أ¢ظ…ظ†ظ‡aa]",A:"[غپط،ط¢ط£ط¤ط¥AA]",c:"[ccأ§]",C:"[CCط§]",d:"[dd]",D:"[Dط°]",e:"[أ¨أ©أھأ«ee]",E:"[ط¨ط©طھط«EE]",g:"[g]",G:"[G]",i:"[ظ‰ظٹأ®أ¯]",I:"[ط¬ط­ط®ط¯]",l:"[lll]",L:"[LLL]",n:"[ظŒnn]",N:"[ط±NN]",o:"[ظچظژأ´ظڈظگظ‘o]",O:"[ط²ط³ط´طµط¶ط·]",r:"[rr]",R:"[RR]",s:"[ع‘ع‘s]",S:"[ظ¹SS]",t:"[tt]",T:"[TT]",ue:"[أ¼]",UE:"[ظ€]",u:"[أ¹ظ’أ»uآµ]",U:"[ط¸ط¹ط؛U]",y:"[غ’â€ژ]",Y:"[ع؛ظپ]",z:"[â€چzz]",Z:"[عکZZ]",th:"[â€ڈ]",TH:"[ظ‚]",dh:"[ظ‹]",DH:"[ط°]",ss:"[ظƒ]",oe:"[إ“]",OE:"[إ’]",ae:"[ظˆ]",AE:"[ط¦]"},b={" ":"[\xa0\u2002\u2003\u2009]","*":"[\xb7]","'":"[\u2018\u2019]",'"':"[\u201c\u201d]","...":"[\u2026]","-":"[\u2013]","--":"[\u2014]","&raquo;":"[\uFFFD]"};
